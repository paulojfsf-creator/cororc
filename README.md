# Coro Litúrgico 7.0 — Biblioteca Enriquecida

Versão 7.0: enriquecimento automático da biblioteca a partir do ficheiro `Programas 2026.xlsx`.

- Registos processados: 457
- Cânticos do catálogo enriquecidos: 214
- Associações históricas: 390
- Títulos do Excel sem correspondência no catálogo atual: 46

## Regras
- O enriquecimento usa o histórico real dos programas de 2026.
- Variações ortográficas são normalizadas para procurar o cântico canónico.
- A informação automática fica separada das fontes litúrgicas oficiais e dos metadados manuais.
- Não transforma automaticamente um cântico histórico numa recomendação litúrgica válida.
- O cálculo de adequação continua subordinado à associação litúrgica e ao Salmo oficial.

## Títulos do Excel sem correspondência
...
- As minhas ovelhas ouvem a minha voz, diz o Senhor; Eu conheço as minhas ovelhas e elas seguem-Me.
- Bendito sejais, ó Pai, Senhor do céu e da terra, porque revelastes aos pequeninos os mistérios do reino.
- Bendito sejais, ó Pai, Senhor do céu e da terra,  porque revelastes aos pequeninos os mistérios do reino.
- Bendito, bendito o que vem                  Glória honra e louvor
...
- Eu sou a luz do mundo, diz o Senhor: quem Me segue terá a luz da vida.
- Eu sou a ressurreição e a vida, diz o Senhor.  Quem acredita em Mim não morrerá para sempre.
...
- Mandai Senhor o vosso espirito
...
- O espirito do Senhor encheu a terra
...
- Tu, menino, serás chamado profeta do Altíssimo,  irás à frente do Senhor a preparar os seus caminhos.
